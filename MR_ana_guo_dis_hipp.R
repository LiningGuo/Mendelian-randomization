...
expo_sig <- fread('/gpfs/lab/groupYU/members/guolining/GLN/MR_ana/dis_expo_format/AD_format.txt')

out_format <- fread('/gpfs/lab/groupYU/members/guolining/GLN/MR_ana/hipps_out_format/0262_format.txt')
#head(out_format)
mydata <- harmonise_data(expo_sig,out_format,action= 2)
#check procy SNP
...
save.image("/gpfs/lab/groupYU/members/guolining/GLN/MR_ana/MR_result/nosig/ad_0285.RData")
rm(list=ls())
